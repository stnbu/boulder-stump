...
You could position this blast-zone by swinging the sluice over the un-mined bits slowly, so that it gently (as it were) eats into virgin river bed[fn:: Of course, the river is not a circle. The sluice's arc went over riverbank, ancient riverbed, low cliffs and the like.]. The force of the water was such that more than just silt and pebbles got stirred up. Head-sized boulders would swirl merrily in this twisting torus of purposeful erosion.
