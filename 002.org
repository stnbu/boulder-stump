...
Both boys ran into the woods and it would turn out, never be seen again by anyone with any confidence[fn:: This was much observed and discussed by all for nearly a moon, when work was consdusive to idle speculation and clay-talk. A few, but only a few called the mystery 'the twins paradox'.].

On this occasion, the men used the same dam but with some pieces missing. The work was exhausting and they needn't over-do things. The men quite a while heaving the boulders into position, each rocking and threatening to topple at any time, and then hopefully stabilized. Behind this, they put several layers of sturdy woven bamboo screens.
...
As today's boulder was more or less in the center of the gouge, the river-fist landed more or less directly on its top. The river's depth now left the top of the large rock more or less flush with the water's surface. Having to discover by trial that rocks would take a shorter path than the water, they lengthened the sluice a bit until the smaller trial boulders, heaved as far up the sluice as could be thrown, were knocking on its top squarely.
