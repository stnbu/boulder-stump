...
The heavy boulders caused the sluice to bounce as they went down, usually not distructively but enough to affect accuracy, and so one man would carry boulders and the other would fine-tune the sluice, carrying boulders to the base of the trestle if the sluice could be left alone for a while.

Gog, while jogging around, noticed that the sluice looked like a trunk-harp[fn:: Some strong, dried sinew tied on one end to a hopefully-hollow trunk, and to a bit of the same tree's root (usually excavated for) on the other end, with a sort of pedal (stick, about 1/2 man long) whose one end was put on the nearby ground and the other against the sinew, near the bottom, that can be pressed variously by a foot to produce different tightness (notes) in the string. Others would strike, slap, rub with smooth honey-tackeyed sticks, dampen, punch, glance with arrows, beat with one's spear or one of your enemy's arms...whatever the trance called for. Glancing the string just right with the fingertips of a human arm made an astonishingly beautiful harp sound that was in great demand. It's quite an instrument given that it can be put together in about a minute.] string, even having different notes. Not being able to see the boulders from below, he had a hunch it had to do with boulder size.
