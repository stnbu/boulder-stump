...
Its enclosing "egg" was a sort of geode that was a semi-transparent dark blue crystal with sparkling silver veins running from the void to the edge of the stone as though "radiating" from the middle. Like the penis had kind of starburst of patterns eminating from it that could only be vaugly glimpsed by breaking the stone, which had been done already by Nature. All who saw it decided it needed no more exploratory cracks.
