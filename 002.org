...
Grav was holding it in his hand in the least sexual way he could manage, inspecting it with wonder. It was a scapolite[fn:: They call this iris-stone, as it sometimes looks in color and richness the medium-brown iris that is universal among them.] about one and one half of one pinkie-thumb long,  ...penis that, could also, for the less banana-minded pass for something else. It was almost a kind of purity test in its ambiguity.
...
Its enclosing "egg" was a sort of geode that was dark blue semi-transparent crystal with sparkling silver veins running from the void to the edge of the stone as though "radiating" from the middle. Like the penis had kind of starburst of patterns eminating from it that could only be vaugly glimpsed by breaking the stone, which had been done already by Nature. All who saw it decided it needed no more exploratory cracks.
