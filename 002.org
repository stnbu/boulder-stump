...
The poplar had been chosen for its straightness (among other things). With a bit of fine-tuning, the sluice could be tuned and squared up such that two men could work it with long pieces of twist-vine, and some heaving.
