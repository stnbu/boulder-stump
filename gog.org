...
Missing conch would mean first getting all-finger lashes, then attending CO lectures regarding obedience, duty and resistance to pain, and finally performing all training that had been scheduled for them that day alone and unsupervised[fn:: The penalty for any kind of shirking was death, so supervision was generally was not required.]. This of course resulted in occasional deaths, so it was a kind of 'death penalty lite'.
