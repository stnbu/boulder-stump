...
For one, they would have to awake and get running dangerously early in order too beat conch. They would get one lash each for not having shaved[fn:: Performed with a purpose-made shard of obsidian and of course some lathery soap.] and not wearing their rhino-calf training armor, which they could retrieve, but not in time to beat conch.
...
And it belonged to an animal smart enough to start work immediately on tearing the spear-guard away from the hide altogether, which for an averaged sized male cat would mean sure death for them, as it could probably fit a good way into the opening and its reach was enough to at least mince you up sufficiently for dying.
...
All of this was accompanied by a sound that caused physical pain in their ears, a twinge of which they would feel the next day. Notes of this could be felt distinctly one's rib cage.
...
A more relatable example to most Crec would be the appearance of a whirlpool going down a natural sink, especially when different kinds of flowering duckweed and floating debris gives it some character and shows its "arms".
...
Both stunned by the unreality of what was happening, they watched the enormous animal do a graceful turn-about that seemed to happen in slow motion, with the beast looking over it's muscular shoulder as he turned.
