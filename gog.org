...
Directions are always with respect to "morning-sun", meaning: The observer faces East to orient[fn:: See? They're not the first.] themselves and all other directions are relative to East.
