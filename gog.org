...
Its "whiskers" were about the thickness of one of Oh-Mas' fingers at their base, where they also had a translucence to them, which seemed to refract the starlight, there suddenly seeming to be no moon or clouds, but only Unnaturally intense starlight. The stars felt /closer/ rather than brighter.
