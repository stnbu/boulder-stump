...
"You've got 'gog' in your eye, scout.", said Grav helpfully. He was repacking both of their kits, forgetting about the remains of Gog's lamp, except for the wick
# do we explain?
, which was perfectly fine, and also rather new.

He was smiling and bobbing his head. "Let's just talk about it later. We need to move."
...
The way to deal with tooth-cats when not in a convenient stone hide is simple: Don't find yourself needing to. And if that fails there a number of good tips and tricks that kept the smart apes on top.
...
A very strong and skilled single man, if also lucky, could wield a spear in each hand and fend of a tooth-cat.
...
Third, consider a nice deep hole. It will need to be at least one and one half of one part in depth of the cat's forearm reach, which could be as much as a man. If the opening is subject to digging, forget it.
