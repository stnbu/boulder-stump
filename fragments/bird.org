...
Grav and Gog could now clearly see the mad beast at the end of the tunnel, the animal now taking some time to express his rage just in front of the opening, and those spikes that now appearing hopelessly flimsy from their angle.
