...
The Crec had latches and vine catches that would make ingress much easier than it was in this case, where they were both struggling, helping one another with a stab here or a smack there (from a poorly timed release of a branch bent out of the way).

The baby gave them exasperated but patient looks as he stopped repeatedly to press back some of the more troublesome spears at their base and wait for the two enormous people to ease past all their many pain points.
