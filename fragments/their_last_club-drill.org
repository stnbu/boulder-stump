...
Grav knew he would the forest-child would not attempt to decipher this first greeting and so not, yet, be tipped off to the fact that they were speaking separate languages, and also knowing he would not be able to make anything of the traveler's response. The encounters were always eerily similar to one another, and each time it seemed they had to build their pantomime vocabulary with them from scratch. But they were practiced, and both men knew in any case, they'd have to get through the first, rather long part where the forest-child is unaware they do not understand.
