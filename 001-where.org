...
Plans for this morning, include: Wander around in the woods with Gog. Gog and Grav were cousins. Pretty much the same age, much-little.
...
They had the same instinct for benefit-crazy-think, a term that means, "to benefit from free and open thinking and doing." Both realized, through their endless talking about ideas, that if you explore the idea places that no one else would because they were lazy or superstitious, you would more easily find value-stones of ideas that, because they were original and unexplored, were more profitable than average.
...
Grav and Gog /were/ friends. They were also, accomplished gentleman philosophers. The advantage they could have had over people was immense, but they used their powers for good. They wanted to have fun and wanted for everyone else to have fun.

Not everyone was of this mind. Verk was staying in the burrow just two down from Grav, and inevitably they would run into each other. Often this was in the relief-burrow, as had happened recently. The relief-burrow was positioned and shaped for optimal sound-deadening, for reasons that would utterly relate to modern readers. It was shaped, looking top-down, something like a daisy; scalloped around the sides so that sound would naturally dampen. The walls were also gently curved from top-to-bottom. It offered the predictable visibility and viewability characteristics of a large, circular room, but didn't have the /acoustical/ characteristics of a large, circular room. Get it?
...
"Good morning Father-Brother Verk. Father-Brother Verk, I was genuinely taken aback by our words from yesterday. I /do/ feel the way you do about our Forest. I know, trust me. I will /never/ forget. My feelings /also/ are quite strong.
...
Grav was sure at least some kind of hint was to follow this. It seemed to break the very rules of caveperson communication to just leave things hanging like this. He raised his eyebrows in a careful effort to relay this observation.
...
"What are you doing today?", asked Verk, still not /using/ the relief-burrow, but now standing where Grav could comfortably look at him, now facial expressions could be used to hopefully gather or send more nuance. However Grav found this too confusing and difficult to do in what he thought was the /usual/ way with Verk.
...
In each hand, Grav was carrying a large hemp basket, heavy with the best mining equipment they could conjure. (xxx describe sum?)

As Grav approached the glade that at the very crook of the confluence[fn:: Where, legend has it, the Crec clan and culture had its beginnings.]. Taking /the short way/ Grav had to stop and a xxx rope??xxx bridge crossing The Great Meal Stone's last angry-cauldron, which delayed him a half-palm.
...
All this angry water out of place created a truly odd and kind of magical Forest-shaking, low rumble that was something like an earthquake that has been ongoing for thousands of years. The dirt doesn't mind. It just gets shaken about. And it turns out plants didn't mind it either, or as many suspect, were just a bit more productive because of the light massage. The occasional tree here and there didn't move visibly, but a hand on the trunk would bring your mind back to the power around you. Trees, and rocks and whatever else hummed harmonically, which added some color to the sea of white noise in the area. Gog had once put a straight, hard, ridged stick hard against a boulder near one of the more dramatic cascades. Putting his ear up to the other end, he could definitely hear an /audible/ hum that was clear and distinct from the surrounding tempest of noise.

Shouting, Grav suggested, "Whatever we do, let's get the scat downstream!"

Gog nodded, turned, and led the way.

The practiced, efficient jog an experienced Forest-man slipped into while following an established path, especially one that follows a river, became hypnotic in a way that Grav loved. The noisy, often unhelpful part of your mind had no choice but to keep making plans and rapidly solving puzzles for one's next steps, which your legs had to perform with a perfect, unbroken rhythm, and sureness.

The top of his vision saw the upcoming terrain, which he kept scanning for possible complications. Lower, nearer part of his vision, he made fine adjustments to his plans, given new information: This rock has wet moss. That footfall has deer scat that we mustn't stir up[fn:: Hunters knew that if the were just /traveling/ and were willing to sacrifice game abundance in the area for maybe the next few palms, it would definitely do no harm to purposely step in, and spread the scat of any predator.]. That limb will break if I land this stride on it. And of course there was the built-in constraint of trying to make as little noise as possible, which added to the immersive challenged that often helped him to think more clearly.

This, he discovered, was cultivatable state: Get into the groove right away and you'll have a pleasant ride as a passenger in your own body. Your mind is now free to wander about the Universe.

Gog felt the same way. For them, even more than most elite Hunters, traveling through the forest was fast, reliably breezy, pleasant and just no big deal. It was a kind of lounging for them. It could be done for hours on end with few breaks (which were their own treat), possibly bringing you to a part of the Forest that, despite being a well-traveled cave man of late-age, you had never seen before. And there were landscapes that even these people, however traveled of the infinite, abundant Forest, would stop stunned to gauze at for lengths of time, mouth agape.
...
"I haven't been alone with him much. I mostly just try to avoid that possibility, honestly. I kind of get the feeling that he needs to let off some steam[fn:: Lit. "throw some rocks"] a lot of the time and I feel like, whoever's job that is, it has got to be a lot of 'work', if you know what I mean.
...
If you've driven those away who just /reasonably/ object to whatever urgent thing you're being lectured on, what's left over are a particular kind of caveperson. Kind of the last-part I'll call it. Or no, 'tail', like what you see disappearing into the bush when you've scared off a big lizard. There's a part that hangs around a bit longer. The 'tail'. Father-Brother Verk's tail of hangers-on are desperate for his approval. They will silently undergo /even worse/ mistreatment by him[fn:: They both felt a stir referring to Verk this way.] which in turn means that mistreatment can /expand/ and meet the new allowance, and so a person's[fn:: Gog was trying to steer back into the /abstract/ caveperson as the topic of conversation.] behavior can get /more/ extreme, which scares those around even more, making them willing to just let any kind of behavior go; pretend it didn't happen. Just don't get 'kicked out', you know what I mean. Rather simple people, usually."
...
The place where they would soon arrive was waiting, with it's turned up mud and various mining implements. There were what could be called water-works for processing bulk quantities course, rocky earth for something rare and stubborn.
...
Its justifying feature was a relay of split bamboo culverts that made about a five thumb-pinkie diameter channel for water. Big enough for an all-finger child to use as a kind of water slide, which happened only once. All the splicing work had been done expertly, so it was about as water-tight as a stone channel over a rope bridge, but it could /swivel/. It was fed by the river starting about one and half of one boulder-door[fn:: 100]. men upstream.[fn:: As the math is tedious here: about 300 meters. Crec reckoning is covered in the appendix.]

The floating-sluice swiveled expertly on a conveniently already extant poplar tree[fn:: Pronounced 'wazlic'] about 10 man high and one and one half man around at the base. It had a polished, dense, shiny sections at intervals where the oiled oak bearings burnished the wood, once worked in, the wood was like smooth, ancient stone. This bit of the rigging would last forever. The sluice itself ran out to a fixed 12 men length and continuously gave a heavy, ongoing, cold, laminar xxxwhindingxxx punch into whatever it was hanging over. Left overnight, it would gouge a parabolic hole into the river bed three man deep.

The poplar had been chosen for its straightness (among other things). With a bit of fine-tuning, the sluice could be leveled such that two men could work it long pieces of twist-vine.

It could be shortened at will, down to just over 9 man. So they had a three-man wide ring (with a break where the sluice was fed from high above, by a raised spill way ), with an outside diameter of 12 man of working area, when viewed from a hawk's flight.

This gave the two men a lot of destructive potential from the local ecology's point of view. They had been making good use of it. One might think that you methodically slice out laser portions of this great ring and patiently sort through what results, and it does go this way in some places. In most places, the pounding water would just completely blast away whatever it was slung over.

You could position this blast-zone by swinging the sluice over the un-mined bits slowly, so that it gently (as it were) eats into virgin river bed. The force of the water was such that more than just silt and pebbles got stirred up. Head-sized boulders would swirl merrily in this twisting torus of purposeful erosion.

"River-Fist", the Workers had named this exciting part of the destruction. After escaping from the more intense parts of the torrent, with a smooth under-hand toss from the deepest part of the tight, symmetrical vortex, over the berm created by the advance of the River-Fist. This was where the Feelers worked, so far, downstream of the River-Fist. They were not in great danger, usually, but they were tethered for safety. The river water, being completely opaque here for obvious reasons, required Feelers to fish around with their feet and stoop, but hopefully not /dive/ down to fetch whatever healthy-sized rock was there and heave it onto the bank, which was tended by rather relaxed crew of Soon-Leave to ensure these did not fall back wastefully. They maintained a berm to check the rocks and boulders soundly, and sometimes helped with the heaving, with an especially stubborn rock. Everybody was naked, boys and baby-makers, and covered entirely in smooth, rich clay. It had the look of a bunch of smart monkeys, uniformly brown monkeys working intensely on some vast, seemingly pointless project.

They hadn't had the Feelers until about three-part-of-four moons[fn:: About three weeks] ago. Inevitably some Worker's child would be flailing around in the already-worked areas and helpfully point out a healthy sized rock that deserved examination. And, quite rarely, but not never did this turn out to be a real value-stone of a value-stone.

]]]iamlost]]] These and lots of others were getting re-buried. They had just been counting on value-stone being be a certain size and no bigger, having seen all their lives the /results/ of all the endless digging and working some piece of rock until it's ready for sale in the market.

The truth was as sloppy and inexact as the xxxworldxxx itself. Sometimes you would pick up a big, plain looking rock only to have it split in half as you're balancing it on your chest and hauling it (out of the way?) You look one side and then the other to see the upturned inner part of the rock glittering with value-stone, often in fascinating patterns. That rock might in turn have an ambling-feast[fn:: Wooly Mammoth] carcass worth of value-stones throughout its "flesh"[fn:: Grav and Gog use this to refer to he useless part of a value-stone bearing rock.] or it might contain nothing of note.

This was all a lot of work, in case you hadn't guessed.

Downstream of the Feelers were, with the size and age of the caveperson descending as we go downstream, were a squirrel-hoard of Feeler-Lookers, who of course had to both feel and look for any rock, according to guidelines regularly communicated, drilled upon, and featured in the mandatory training skit, were nervous new-hires would sit uncomfortably, watching the Training Troupe explain the criteria by which they were to identify and handle potential value-stone. And they were many[fn:: Appendix].

Downstream of the Feeler-Lookers were, of course, the Lookers. These were the youngest and smallest, and the broad, shallow, and now comparatively gentle Lame Rhino. To the extent possible, Gog[fn:: Who somehow ended up with the "cavepeople problems."] would only hire the more clever children for this role. It was easy physically, but it was important and so needed to be done right; to the extent possible.

The Lookers' job was to accurately discover evidence that the sluice was encountering value-butter[fn:: Gold]. A river like The Lame Rhino always had flakes of mica and pyrite[fn:: Which they had names for] and these had to be distinguished from value-butter. If even a only flake or two was seen and confidently identified (Gog was always working on an accurate read of 'confident' with these most unsophisticated Workers. It was an ongoing dance.) a number of things were to happen with purposefulness and promptness.
...
By the time the water came back down to the level of the spill way, after shooting up (mostly) it was about as destructive as a thrice-in-life very heavy rain. By the time it got down to the great pylons supporting the raised spillway, it was pretty much like a regular afternoon summertime sky-draining. The youngest and least employed played wildly under the heavy, cold shower. Small-ones[fn:: Toddlers. Contrast "quiet-ones"] usually outnumbered the older, working people. Some of them were there with mother or father. Some of them just showed up, and sometimes even spoke fluently in an unknown tongue, and no other.
...
After knocking out a lot of growth they were pleased to find that they had a dappling of sunlight for most of the day provided by a mesh above of healthy[fn:: G&G had a Worker dedicated to caring for what they called their 'office-plants'.] variegated, fat, yellow-green leaves sprouting from a cobweb of very determined vine whose corresponding anchoring to the ground was hopelessly undeterminable. It was like a fabric woven of living vine, truly.
...
He looked at his left nipple, wrinkling his chin with his determination to get a better look. Gog looked without being seen.
...
The two men were exhausted and both thinking it was time to move on to other schemes. Probably. There were still a few down there and near the center was the one that both had independently discovered, made mental note of, and didn't discuss until now.

"That one in the middle is especially big.", said Gog.

"Yeah. That contraption we were thinking on to rope those out could stand to be ready about now. That's bigger than the one that inspired us!", said Grav.
...
"If we can swing the sluice back and forth fast enough, we can make it sway back and forth[fn:: The men called this technique 'self-shake-rhythm'.]. It's too bad we can't rope it up and..."

"Great Questions!", exclaimed Grav.

"What?"

"We could roll stones down the sluice and hammer it with them. There's enough strength in the water to push some big stones. Maybe even boulders[fn:: Their reckoning was about 273 millimeters, ours is 256.]."
...
Grav and Gog had clambered up to the falls where a dam had been constructed to divert most of the river several months ago. The twin of a small-one owned by a Worker interrupted a planning meeting in a panic insisting that his brother was pinned under a boulder. After lots of very focused, serious questioning, the boy said this was about two boulder-door men downstream where the river pinched and became more rapid.

The whole mine had come together to rapidly re-enable the dam to send the river on a different (as of then, virgin) course, which had been spotted and identified as a good place to do this moons before. There was lowering the river, and then there was "stopping" the river. The stated goal of this dam was the latter.

They happened to also be shorthanded that day and worked frantically, if only to recover a body. The men who went and returned from downstream said it was too deep and strong to safely explore possible boulders, of which there were many. The one the boy pointed to was impossible. The best that might be done is to dislodge the body with a long tree trunk handled by many men.

The dam building had completed in about 45 minutes, with only the powerful spray between boulders feeding the river at this point. And a hungry torrent heading roughly at a right angle to the river's original course soon took out trees and made a gorge that would surely need a name eventually.

The men spent a quarter day heaving the boulders into position. Each rocking and threatening to topple at any time. Behind this, they put several layers of sturdy woven bamboo screens.
...
A chain of men, headed out when it was only just marginal, long enough to peek, peek again, and if possible feel under several boulders, including the prime candidate.
...
"All-Questions! You troublesome boy. If we ever figure out who your here with, we are going to ask them never to bring you again."

Both boys ran into the woods and it would turn out, never be seen again by anyone with any confidence.

As today's boulder was more or less in the center of the gouge, the river-fist landed more or less directly on its top. The river's depth now left the top of the large rock more or less flush with the water's surface. Having to discover by trial that rocks would take a shorter path than the water, they lengthened the sluice a bit until the smaller trial boulders, heaved up as far up the sluice as could be thrown, were knocking on its top squarely.

There were no good places to just pick up boulders and drop them in the sluice. The only option was hauling the biggest boulders they could carry up the zig-zag of ladders to the top of the sluice where it's fed by the spillway. This they did, and after an infuriating walk or two down to adjust the spillway, they had a reliable way to konk the large, intriguing boulder right on its head, over and over, with the biggest boulders they care to carry one half boulder-door men up a series of ladders.
...
After washing the whole works in the river and scrubbing lightly with the finest silt they could find, the let the three pieces dry on the rocks for a palm or two and talked.
...
Verk did a triple-take with a broad, yellow smile for the clan portraitist and anyone else with a keen memory. He pried the two halves apart with a fine, glittering Sky Clam halve[fn:: These were found on the top of nearby /Mnt. Fish/. No one knew how or why.] and a healthy-looking, tough, thick, velvety leaf which he used to protect the parimiter of the mirror-stone finish he had been assured he would find, among other wonders that he insisted remain a surprise.
...
"My sweet Ender-Of-Questions, in his hammock above!", Verk covered his open mouth with the fingertips of both hands in a somewhat dainty gesture, and smiled warmly. "It is /astonishing/.", stretching the syllables.
...
"Things in Nature do not have abruped, sharp ends like we see here." (pointing) "Unless it is cleanly cut by a blade, like the fallen arm stumps we may see in glorious battle."
...
The two men, having most matierals already handy, re-secured the egg and its yolk, hanging it from the same well-suited springy tree branch. Hoisting the xxxx over to two of Verk's Under-Men's sholders, who watching Verk's retreat towards the exit, haistily set off in a trot towards xxxx verk's own local hill xxx passing Verk as stopped and turned at the exit.
...
The two men souluted by grabbing their left ankle with their right hand, locking their right knee, straightening and looking straight ahead at infinity with their shoulders square. "With the mind of a ambling-feast in rut, in a blizzard, our Upper-Brother leader Father-Brother Verk! We will be there!"

Gog said this alone as Grav did his best to make broad, sincere eyes. The men had not yet mastered speaking-as-one-in-battle[fn:: The meaning is obvious if you think in terms of the need for soldiors to not only act as one, but to literally think as one. This is a resource that modern humans are almost entirely without. A feirce sense of personal sovrighnty that exists, even in remote, simpler communities of any left-over bit of 'primitive' culture still present in our world, in all modern humans has been a kind of wrench in the works of humanity, but also a great blessing. Humanity took a kind of fork in the cultural progression road, some time long ago. With practice the Crec, any Crec and most tribes known by them at the time could, when under extreeme durress where lives or maybe whole cultures are at stake, literally respond as one to their supperiors, so thorough was military training. One helpful factor, in your defense is that battle lacks a lot of nuance and the overall tasks are few.], which is a practice solders of at least mid-rank were expected to do.

Verk squinted and stepped out into the pink late afternoon.

"Fare well for now, boys!"

]]] Gog needs to carry a hemp bag!
